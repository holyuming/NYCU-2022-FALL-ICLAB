...
write -format verilog -output Netlist/TT_SYN.v -hierarchy
write_sdf -version 3.0 -context verilog -load_delay cell Netlist/TT_SYN.sdf -significant_digits 6
write_sdc Netlist/TT_SYN.sdc
